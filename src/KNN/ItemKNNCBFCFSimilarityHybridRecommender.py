...
class ItemKNNCBFCFSimilarityHybridRecommender(ItemKNNSimilarityHybridRecommender):
    ...
    def __init__(
        ...
        item_knncf_recommender.fit(topK=topK_knncf,shrink=shrink_knncf,similarity=similarity)

        item_knncbf_recommender = ItemKNNCBFRecommender(URM_train=URM_train, ICM_train=ICM_train, verbose=verbose)

        item_knncbf_recommender.fit(topK=topK_knncbf,shrink=shrink_knncbf,similarity=similarity)
