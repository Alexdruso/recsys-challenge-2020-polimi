...
def BO_func(
    ...
    recommender_normal.fit(topK=int(topKNormal), alpha=alpha)

    result_dict, _ = evaluator_validation.evaluateRecommender(recommender_normal)
...
with open("logs/" + recommender_normal.RECOMMENDER_NAME + "_normal_logs.json", 'w') as json_file:
