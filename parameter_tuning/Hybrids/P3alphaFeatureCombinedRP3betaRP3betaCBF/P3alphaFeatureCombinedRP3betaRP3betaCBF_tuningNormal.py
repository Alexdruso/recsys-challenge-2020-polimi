...
for index in range(len(URMs_train)):
    ...
    p3alpha_recommenders[index].fit(
        topK=int(228.70418042676988),
        alpha=0.5059173017438977,
        implicit=True
    )
    ...
    rp3betaCombined_recommenders[index].fit(
        topK=int(515.6809872778197),
        alpha=0.4227727007111746,
        beta=0.23482852065641355,
        implicit=False
    )
...
with open("logs/P3alphaFeatureCombinedRP3betaRP3betaCBF_normal_logs.json", 'w') as json_file:
